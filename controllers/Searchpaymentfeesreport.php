			...
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) {
                    ...
                    if((int)$gspaymentID && (($gspayment == 'INV-G-') || ($gspayment == 'inv-g-'))) {
                        ...
                        $this->data['globalpayments'] = $this->payment_m->get_globalpayments_ref_no($gspaymentID);
                    	...
                    	$this->data['singlepayments'] = $this->payment_m->get_single_payment_by_ref_no($gspaymentID);
