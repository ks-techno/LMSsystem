		...
		if((int)$classesID && (int)$sectionID && (int)$schoolyearID) {
			...
			if(customCompute($students)) {
				foreach($students  as $student) {
					...
					echo "<option value=\"$student->srstudentID\">".$student->srname ." (". $student->registerNO .") (". $student->roll .")</option>";
				}
			}
		}
	}
        ...
        if(permissionChecker('librarybookissuereport')) {
			if($_POST) {
			    ...
			    if ($this->form_validation->run() == FALSE) {
					...
					$this->data['registration_no'] 	= $this->input->post('registration_no');
					$this->data['name']      		= $this->input->post('name');
					$this->data['roll']      		= $this->input->post('roll');
					$this->data['regno']      		= $this->input->post('regno');
