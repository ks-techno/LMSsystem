...
use Omnipay\Omnipay;
class Libraryfine extends Admin_Controller {
    /*
    | -----------------------------------------------------
    ...
    */
    ...
    function __construct() {
        ...
        $this->lang->load('libraryfine', $language);
    ...
    public function index() {
        ...
        if($usertypeID == 3) {
            ...
            if(customCompute($student)) {
                ...
                $this->data["subview"] = "libraryfine/index";
            ...
            if(isset($_POST['searchInvoice'])){
                ...
                $this->session->set_userdata(array("searchInvoice"=>$searchInvoice));
                $count = $this->maininvoice_m->count_maininvoice_with_studentrelation($schoolyearID,'invoice',$searchInvoice);
                $link = "libraryfine/?searchInvoice=".$searchInvoice;
                $returns = $this->paginationCompress ( "libraryfine/", $count, 10 );
                $this->data['maininvoices'] = $this->maininvoice_m->get_maininvoice_with_studentrelation_pag($returns["page"], $returns["segment"],$schoolyearID,'library_fine',$searchInvoice);
                ...
                $returns = $this->paginationCompress ( "libraryfine/", $count, 10 );
                $this->data['maininvoices'] = $this->maininvoice_m->get_maininvoice_with_studentrelation_pag($returns["page"], $returns["segment"],$schoolyearID,'library_fine','',$yearly);
            }else{
                if($this->session->userdata('searchInvoice') != NULL && $this->uri->segment(2)){
                    ...
                    $returns = $this->paginationCompress ( "libraryfine/", $count, 10 );
                    $this->data['maininvoices'] = $this->maininvoice_m->get_maininvoice_with_studentrelation_pag($returns["page"], $returns["segment"],$schoolyearID,'library_fine',$search_text);
                }else{
                    ...
                    $returns = $this->paginationCompress ( "libraryfine/", $count, 10 );
                    $this->data['maininvoices'] = $this->maininvoice_m->get_maininvoice_with_studentrelation_pag($returns["page"], $returns["segment"],$schoolyearID,'library_fine');
                }
            }
...
// 		$config ['uri_segment'] = SEGMENT;
    ...
    public function add() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            ...
            $this->data["subview"] = "libraryfine/add";
            $this->load->view('_layout_main', $this->data);
        } else {
            $this->data["subview"] = "error";
            $this->load->view('_layout_main', $this->data);
            ...
            if((int)$maininvoiceID) {
                ...
                if(customCompute($this->data['maininvoice'])) {
                    if($this->data['maininvoice']->maininvoicestatus == 0) {
                        ...
                        $this->data["subview"] = "libraryfine/edit";
                        $this->load->view('_layout_main', $this->data);
                    } else {
                        $this->data["subview"] = "error";
                        $this->load->view('_layout_main', $this->data);
            ...
            if((int)$maininvoiceID) {
                ...
                if(customCompute($maininvoice)) {
                    if($maininvoice->maininvoicestatus == 0) {
                        ...
                        redirect(base_url('libraryfine/index'));
                    } else {
                        $this->data["subview"] = "error";
                        $this->load->view('_layout_main', $this->data);
                    }
            ...
            if((int)$id) {
                ...
                if(customCompute($getstudent)) {
                    ...
                    if(customCompute($this->data['maininvoice']) && ($this->data['maininvoice']->maininvoicestudentID == $getstudent->studentID)) {
                        ...
                        $this->data["subview"] = "libraryfine/view";
                        $this->load->view('_layout_main', $this->data);
                    } else {
                        $this->data["subview"] = "error";
                        $this->load->view('_layout_main', $this->data);
            ...
            if($usertypeID == 3) {
                ...
                if((int)$id) {
                    ...
                    if(customCompute($getstudent)) {
                        ...
                        if(customCompute($this->data['maininvoice']) && ($this->data['maininvoice']->maininvoicestudentID == $getstudent->studentID)) {
                            ...
                            $this->data['createuser'] = getNameByUsertypeIDAndUserID($this->data['maininvoice']->maininvoiceusertypeID, $this->data['maininvoice']->maininvoiceuserID);
                            $this->voucherPDF('vouchermodule.css',$this->data, 'libraryfine/print_preview');
                            // $this->reportPDF('invoicemodule.css',$this->data, 'libraryfine/print_preview');
                        } else {
                            $this->data["subview"] = "error";
                            $this->load->view('_layout_main', $this->data);
                        }
                ...
                if((int)$id) {
                    ...
                    if($this->data["maininvoice"]) {
                        ...
                        $this->data['createuser'] = getNameByUsertypeIDAndUserID($this->data['maininvoice']->maininvoiceusertypeID, $this->data['maininvoice']->maininvoiceuserID);
                        // $this->voucherPDF('invoicemodule.css',$this->data, 'libraryfine/print_preview');
                        $this->voucherPDF('vouchermodule.css',$this->data, 'libraryfine/print_preview');
                    ...
                    if($f) {
                        ...
                        if((int)$id) {
                            ...
                            if(customCompute($this->data["maininvoice"])) {
                                ...
                                $this->reportSendToMail('invoicemodule.css', $this->data, 'libraryfine/print_preview', $to, $subject, $message);
                    ...
                    if($maininvoice->maininvoicestatus != 2) {
                        ...
                        if(customCompute($this->data['student'])) {
                            ...
                            if($f) {
                                ...
                                $this->data['maininvoices'] = $this->maininvoice_m->get_order_by_maininvoice(array('maininvoiceID' => $id));
                                // if (isset($_GET['dev'])){
                                ...
                                if($_POST) {
                                    ...
                                    $this->form_validation->set_rules($rules);
                                    if($this->form_validation->run() == FALSE) {
                                        $this->data["subview"] = "libraryfine/payment";
                                        $this->load->view('_layout_main', $this->data);
                                    } else {
                                        if($this->input->post('paymentmethodID') == 'Cash' || $this->input->post('paymentmethodID') == 'Cheque' || $this->input->post('paymentmethodID') == 'Bank') {
                                                ...
                                                foreach ($this->data['invoices'] as $key => $invoice) {
                                                    if($invoice->paidstatus != 2) {
                                                        ...
                                                        if($this->input->post('weaver_'.$invoice->invoiceID) > 0){
                                                            $totaldiscount = $this->input->post('weaver_'.$invoice->invoiceID);
                                                            // echo '<br>';
                                                        ...
                                                        // if (isset($_GET['dev'])){
                                                            ...
                                                            if (($p_amount > $invoice->maininvoicenet_fee || $p_amount == $invoice->maininvoicenet_fee) && $invoice->maininvoicestatus != 2){
                                                                ...
                                                                if ($invoice->maininvoicestatus == 1) {
                                                                    $main_net = $invoice->maininvoicetotal_fee - $invoice->maininvoice_discount - $totaldiscount;
                                                                    $this->maininvoice_m->update_maininvoice(['maininvoicestatus' => 2, 'maininvoicecreate_date' => date("Y-m-d", strtotime($this->input->post('date'))), 'maininvoicenet_fee' => $invoice->maininvoicenet_fee - $p_amount - $totaldiscount, 'maininvoice_discount' => $invoice->maininvoice_discount + $totaldiscount],$invoice->maininvoiceID);
                                                                }else{
                                                                     $main_net = $invoice->maininvoicenet_fee - $totaldiscount;
                                                                    $this->maininvoice_m->update_maininvoice(['maininvoicestatus' => 2, 'maininvoicecreate_date' => date("Y-m-d", strtotime($this->input->post('date'))), 'maininvoicenet_fee' => $invoice->maininvoicenet_fee - $p_amount - $totaldiscount, 'maininvoice_discount' => $invoice->maininvoice_discount + $totaldiscount],$invoice->maininvoiceID);
                                                                }
                                                                ...
                                                                $paidstatus = 2;
                                                                $this->invoice_m->update_invoice(array('paidstatus' => $paidstatus,'pay_type' => 'cpv','create_date' => date("Y-m-d", strtotime($this->input->post('date'))), 'net_fee' => $invoice->maininvoicenet_fee - $p_amount - $totaldiscount , 'discount' => $invoice->maininvoice_discount + $totaldiscount), $invoice->invoiceID);
                                                                ...
                                                                $mainnet_fee = $invoice->maininvoicenet_fee;
                                                                $this->maininvoice_m->update_maininvoice(['maininvoicenet_fee' => $invoice->maininvoicenet_fee - $p_amount - $totaldiscount, 'maininvoice_discount' => $invoice->maininvoice_discount + $totaldiscount],$invoice->maininvoiceID);
                                                                $this->maininvoice_m->update_maininvoice(['maininvoicestatus' => 1, 'maininvoicecreate_date' => date("Y-m-d", strtotime($this->input->post('date')))], $invoice->maininvoiceID);
                                                                ...
                                                                $this->invoice_m->update_invoice(array('paidstatus' => $paidstatus,'pay_type' => 'cpv','create_date' => date("Y-m-d", strtotime($this->input->post('date'))), 'net_fee' => $invoice->maininvoicenet_fee - $p_amount - $totaldiscount , 'discount' => $invoice->maininvoice_discount + $totaldiscount), $invoice->invoiceID);
                                                                $p_amount = $p_amount - $mainnet_fee;
                                                            }else if($p_amount == 0 && $totaldiscount == $invoice->maininvoicenet_fee){
                                                                $mainnet_fee = $invoice->maininvoicenet_fee;
                                                                $this->maininvoice_m->update_maininvoice(['maininvoicenet_fee' => 0, 'maininvoice_discount' => $invoice->maininvoicenet_fee],$invoice->maininvoiceID);
                                                                $this->maininvoice_m->update_maininvoice(['maininvoicestatus' => 2, 'maininvoicecreate_date' => date("Y-m-d", strtotime($this->input->post('date')))], $invoice->maininvoiceID);
                                                                // $this->data['invoices'] = $this->invoice_m->get_order_by_invoice(array('maininvoiceID' => $invoice->maininvoiceID, 'deleted_at' => 1));
                                                                $paymentArray = array(
                                                                    'invoiceID' => $invoice->invoiceID,
                                                                    'schoolyearID' => 1,
                                                                ...
                                                                $paymentLastID = $this->db->insert_id();
                                                                $paidstatus = 2;
                                                                $this->invoice_m->update_invoice(array('paidstatus' => $paidstatus,'pay_type' => 'cpv','create_date' => date("Y-m-d", strtotime($this->input->post('date'))), 'net_fee' => 0 , 'discount' => $invoice->maininvoicenet_fee), $invoice->invoiceID);
                                                                $p_amount = 0;
                                                            }else if($p_amount == 0 && $totaldiscount < $invoice->maininvoicenet_fee){
                                                                $mainnet_fee = $invoice->maininvoicenet_fee;
                                                                $this->maininvoice_m->update_maininvoice(['maininvoicenet_fee' => $invoice->maininvoicenet_fee - $p_amount - $totaldiscount, 'maininvoice_discount' => $invoice->maininvoice_discount + $totaldiscount],$invoice->maininvoiceID);
                                                            ...
                                                            redirect(base_url('libraryfine/view/'.$id));
                                            ...
                                            if($this->input->post('paymentmethodID') == 'Paypal') {
                                                ...
                                                redirect(base_url("libraryfine/payment/$id"));
                                            }
                                        }
                                    }
                                } else {
                ...
                if(customCompute($maininvoice) && customCompute($globalpayment)) {
                    ...
                    if($f) {
                        ...
                        if(customCompute($studentrelation)) {
                            ...
                            $this->data["subview"] = "libraryfine/viewpayment";
                            $this->load->view('_layout_main', $this->data);
                        } else {
                            $this->data["subview"] = "error";
                            $this->load->view('_layout_main', $this->data);
                ...
                if(customCompute($maininvoice) && customCompute($globalpayment)) {
                    ...
                    if($f) {
                        ...
                        if(customCompute($studentrelation)) {
                            ...
                            $this->reportPDF('invoicemodulepayment.css',$this->data, 'libraryfine/print_previewviewpayment');
                        } else {
                            $this->data["subview"] = "error";
                            $this->load->view('_layout_main', $this->data);
                        }
                        ...
                        if(customCompute($maininvoice) && customCompute($globalpayment)) {
                            ...
                            if($f) {
                                ...
                                if(customCompute($studentrelation)) {
                                    ...
                                    $this->reportSendToMail('invoicemodulepayment.css', $this->data, 'libraryfine/print_previewviewpayment', $to, $subject, $message);
                                    $retArray['message'] = "Success";
                                    $retArray['status'] = TRUE;
                                    echo json_encode($retArray);
                                } else {
                            ...
                            // if(customCompute($feetypeitems)) {
                                // foreach ($feetypeitems as $feetypeitem) {
                                    $invoiceArray[] = array(
                                        ...
                                        'feetype' => $feess_type,
                                        'refrence_no' => $ref_no,
                                        // 'maininvoicetotal_fee' => $invoiceMainArray[$j]['maininvoicetotal_fee'],
                                    ...
                                    if(customCompute($feetypeitems)) {
                                        foreach ($feetypeitems as $feetypeitem) {
                                            $invoiceArray = array(
                                                ...
                                                'amount' => isset($feetypeitem->amount) ? $feetypeitem->amount : 0,
                                                'discount' => (isset($feetypeitem->discount) ? (($feetypeitem->discount == '') ? 0 : $feetypeitem->discount) : 0),
                                                'net_fee' =>  (isset($feetypeitem->subtotal) ? (($feetypeitem->subtotal == '') ? 0 : $feetypeitem->subtotal) : 0),
                                    ...
                                    if(customCompute($feetypeitems)){
                                        foreach ($feetypeitems as $feetypeitem){
                                             $mainInvoiceArray = array(
                                                ...
                                                'maininvoicetotal_fee' => isset($feetypeitem->amount) ? $feetypeitem->amount : 0,
                                                'maininvoice_discount' => (isset($feetypeitem->discount) ? (($feetypeitem->discount == '') ? 0 : $feetypeitem->discount) : 0),
                                                'maininvoicenet_fee' =>  (isset($feetypeitem->subtotal) ? (($feetypeitem->subtotal == '') ? 0 : $feetypeitem->subtotal) : 0),
        ...
        if(permissionChecker('invoice_view')) {
            ...
            if(!empty($maininvoiceID) && (int)$maininvoiceID && $maininvoiceID > 0) {
                ...
                if(customCompute($maininvoice)) {
                    ...
                    if(customCompute($invoices)) {
                        foreach ($invoices as $invoice) {
                            $payments = $this->payment_m->get_orderr_by_payment(array('invoiceID' => $invoice->invoiceID, 'studentID' => $maininvoice->maininvoicestudentID));
                                    ...
                                    foreach ($allpayments[$globalpaymentobject->globalpaymentID] as $payment) {
                                        if(isset($paymentlists[$globalpaymentobject->globalpaymentID])) {
                                            ...
                                            $paymentlists[$globalpaymentobject->globalpaymentID] = array(
                                                ...
                                                'refrence_no' => $payment->refrence_no
                                            );
                                        }
                                    }
                ...
                if(customCompute($paymentlists)) {
                    ...
                    foreach ($paymentlists as $key => $paymentlist) {
                        ...
                        if(permissionChecker('invoice_view')) {
                            echo '<a href="'.base_url('libraryfine/viewpayment/'.$paymentlist['globalpaymentID'].'/'.$maininvoiceID).'" class="btn btn-success btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="'.$this->lang->line('view').'"><i class="fa fa-check-square-o"></i></a>';
                        }
                        ...
                        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) {
                            if(($this->lang->line('Cash') == $paymentlist['paymenttype']) || ($this->lang->line('Cheque') == $paymentlist['paymenttype']) || ('Cash' == $paymentlist['paymenttype']) || ('Cheque' == $paymentlist['paymenttype'])) {
                                if(permissionChecker('invoice_delete')) {
                                    echo '<a href="'.base_url('libraryfine/deleteinvoicepaid/'.$paymentlist['globalpaymentID'].'/'.$maininvoiceID).'" onclick="return confirm('."'".'you are about to delete a record. This cannot be undone. are you sure?'."'".')" class="btn btn-danger btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="'.$this->lang->line('delete').'"><i class="fa fa-trash-o"></i></a>';
                                }
                            }
                        }
                        echo '</td>';
    ...
    private function Paypal() {
        ...
        if($api_config['paypal_api_username'] =="" || $api_config['paypal_api_password'] =="" || $api_config['paypal_api_signature']==""){
            ...
            $params = array(
                'cancelUrl'     => base_url('libraryfine/getCancelPayment'),
                'returnUrl'     => base_url('libraryfine/getSuccessPayment'),
                'weaverUrl'     => base_url('libraryfine/getSuccessWeaverPayment'),
    ...
    public function getCancelPayment() {
        ...
        redirect(base_url('libraryfine/view/'.$params['invoice_id']));
    }
            ...
            if((float)($this->item_data['amount'] + $this->item_data['fine'])  == 0) {
                ...
                try {
                    ...
                    if ($response->isSuccessful()) {
                            ...
                            if (!customCompute($dbTransactionID)) {
                                ...
                                if(customCompute($this->invoice_info)) {
                                    ...
                                    if(customCompute($this->data['student'])) {
                                        ...
                                        $this->session->set_flashdata('error', 'Student does not found.');
                                        redirect(base_url('libraryfine/view/'.$this->item_data['id']));
                                    }
                                } else {
                                    $this->session->set_flashdata('error', 'Invalid invoice');
                                    redirect(base_url('libraryfine/view/'.$this->item_data['id']));
                        ...
                        redirect(base_url('libraryfine/payment/' . $this->item_data['id']));
                    }
                } catch (\Exception $ex) {
    ...
    public function payumoney() {
        ...
        if($api_config['payumoney_key'] =="" || $api_config['payumoney_salt'] ==""){
            ...
            $this->invoice_info = (array)$this->invoice_data;
            $params = array(
                'cancelUrl'     => base_url('libraryfine/payumoney_canceled'),
                'failedUrl'     => base_url('libraryfine/payumoney_failed'),
                'returnUrl'     => base_url('libraryfine/payumoney_successful'),
                'weaverUrl'     => base_url('libraryfine/getSuccessWeaverPayment'),
                'invoice_id'    => $this->item_data['id'],
                'name'      	=> $this->invoice_info['srname'],
                'description'   => $this->invoice_info['feetype'],
            ...
            if((float)($this->item_data['amount'] + $this->item_data['fine'])  == 0) {
                ...
                $this->array['surl'] = base_url('libraryfine/payumoney_success/'.$this->item_data['id']);
                $this->array['furl'] = base_url('libraryfine/payumoney_failed/'.$this->item_data['id']);
                ...
                $this->array['curl'] = base_url('libraryfine/payumoney_canceled/'.$this->item_data['id']);
                $this->array['service_provider'] = 'payu_paisa';
                $this->array['hash'] = $this->generateHash($this->array);

                $this->load->view('libraryfine/payumoney', $this->array);
            }
        }
    }
    ...
    public function payumoney_failed() {
        ...
        redirect(base_url("libraryfine/view/".$invoice));
    }
    ...
    public function voguepay() {
        ...
        if($api_config['voguepay_merchant_id'] =="" || $api_config['voguepay_merchant_ref'] =="" || $api_config['voguepay_developer_code'] =="" || $api_config['voguepay_status'] == 0){
            ...
            $this->invoice_info = (array)$this->invoice_data;
            $params = array(
                'fail_url'     	=> base_url('libraryfine/voguepay_failed/' . $this->item_data['id']),
                'notify_url'   	=> base_url('libraryfine/voguepay_notify/' . $this->item_data['id']),
                'success_url'  	=> base_url('libraryfine/voguepay_success/' . $this->item_data['id']),
                'weaverUrl'    	=> base_url('libraryfine/getSuccessWeaverPayment'),
                'invoice_id'   	=> $this->item_data['id'],
                'name'      	=> $this->invoice_info['srname'],
                'description'   => $this->invoice_info['feetype'],
            ...
            if((float)($this->item_data['amount'] + $this->item_data['fine'])  == 0) {
                ...
                $this->array['success_url']    = base_url('libraryfine/voguepay_success/' . $this->item_data['id']);
                $this->array['notify_url']     = base_url('libraryfine/voguepay_notify/' . $this->item_data['id']);
                $this->array['fail_url']       = base_url('libraryfine/voguepay_failed/' . $this->item_data['id']);
                $this->array['action']         = $api_link;
                ...
                $this->load->view('libraryfine/voguepay', $this->array);
            }
        }
    }
        ...
        if(isset($_POST["transaction_id"])) {
            ...
            if ($result->state=="success") {
                ...
                if(!customCompute($dbTransactionID)) {
                    ...
                    $this->session->set_flashdata('error', 'Transaction ID already exist!');
                    redirect(base_url("libraryfine/view/".$invoiceID));
                }
            } else {
                redirect(base_url("libraryfine/view/".$invoiceID));
            }
