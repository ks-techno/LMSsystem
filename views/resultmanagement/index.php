    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if(permissionChecker('resultmanagement_add')) { ?>
                    <h5 class="page-header">
                        <a href="<?php echo base_url('resultmanagement/add') ?>">
                ...
                <div class="form-group col-sm-4" id="examDiv" style="display: none !important;">
...
<script type="text/javascript">
    ...
    function ajaxCall(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('resultmanagement/getStudentList')?>",
            data: passData,
            dataType: "html",
            success: function(data) {
