                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12 list-group-item list-group-item-warning">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group <?=form_error('sectionID') ? 'has-error' : ''?>">
                                        ...
                                        <?php
                                            ...
                                            foreach ($class_sec as $sec) {
                                                $array[$sec->sectionID] = $sec->section;
                                            }
                                            echo form_dropdown("sectionID", $array, set_value("sectionID", $sectionID), "id='sectionID' class='form-control select2'");
                                        ?>
                                        <span class="control-label">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group <?=form_error('psectionID') ? 'has-error' : ''?>">
                                        <label for="psectionID" class="control-label">
                                            Semester <span class="text-red">*</span>
                                        </label>
                                        ...
                                        <?php
                                            ...
                                            echo form_dropdown("psectionID", $array, set_value("psectionID", 0), "id='psectionID' class='form-control select2'");
                                        ?>
                                        <span class="control-label">
                                            <?php echo form_error('psectionID'); ?>
                                        </span>
                                    </div>
                                </div>
