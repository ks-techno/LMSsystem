        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="col-sm-4 col-sm-offset-4 box-layout-fame">
                    ...
                    <h5 style="text-align: center">
                        <?=$this->lang->line('promotion_currentSchoolyear')?> : <?=$currentSchoolYear->section?>
                    </h5>
                    <h5 style="text-align: center">
                    ...
                    <h5 style="text-align: center">
                        <?=$this->lang->line('promotion_promotionSchoolyear')?> : <?=$promotionSchoolYear->section?>
                    </h5>
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="col-sm-3 col-sm-offset-9 list-group" style="display: none;" >
