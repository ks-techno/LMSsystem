        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <?php 
                        if(form_error('numric_code')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="numric_code" class="col-sm-2 control-label">
                            Numric Code <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="numric_code" name="numric_code" value="<?=set_value('numric_code', $section->numric_code)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php
                        if(form_error('enrollment_date'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="enrollment_date" class="col-sm-2 control-label">
                            Enrollment Date <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control date" id="enrollment_date" name="enrollment_date" value="<?=set_value('enrollment_date', date('d-m-Y',strtotime($section->enrollment_date)))?>" >
                        </div>
                        <span class="col-sm-4 control-label">
