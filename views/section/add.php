            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="numric_code" name="numric_code" value="<?=set_value('numric_code')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control date" id="enrollment_date" name="enrollment_date" value="<?=set_value('enrollment_date')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
