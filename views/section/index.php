                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-2">Numric Code</th>
                                <th class="col-lg-2">Enrollment Date</th>
                        ...
                        <tbody>
                            <?php if(customCompute($sections)) {$i = 1; foreach($sections as $section) { ?>
                                <tr>
                                    ...
                                    <td data-title="Numric Code">
                                        <?php echo $section->numric_code; ?>
                                    </td>
                                    <td data-title="Enrollment Date">
                                        <?php
                                        if ($section->enrollment_date!=NULL) {
                                            echo date('d-m-Y',strtotime($section->enrollment_date));
                                        }else{
                                            echo "Enrollment Date Not Set";
                                        }
                                          ?>
