            ...
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="tbalance" name="tbalance" value="<?=set_value('tbalance', $tmember->tbalance)?>" readonly >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php 
                        if(form_error('transport_discount')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="transport_discount" class="col-sm-2 control-label">
                            <?=$this->lang->line("tmember_tfee")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_discount" name="transport_discount" value="<?=set_value('transport_discount', $tmember->transport_discount)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('transport_discount'); ?>
                        </span>
                    </div>
