                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="transport_discount" class="col-sm-2 control-label">
                           Transport Discount<span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="transport_discount" name="transport_discount" value="<?=set_value('transport_discount', "0")?>" >
                        </div>
                        <span class="col-sm-4 control-label">
