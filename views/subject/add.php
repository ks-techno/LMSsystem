        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_multiselect("teacherID[]", $array, set_value("teacherID", $teachersID), "id='teacherID' placeholder='Please Select' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php
                        if(form_error('credit_hour'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="credit_hour" class="col-sm-2 control-label">
                            Credit Hour <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="credit_hour" name="credit_hour" value="<?=set_value('credit_hour')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('credit_hour'); ?>
                        </span>
                    </div>
