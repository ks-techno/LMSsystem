            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                $sID = 0;
                                if($subject->sectionID == 0) {
                                    $sID = 0;
                                } else {
                                    $sID = $subject->sectionID;
                                }
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="credit_hour" name="credit_hour" value="<?=set_value('credit_hour', $subject->credit_hour)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
