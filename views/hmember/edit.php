            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_input("bookDate", set_value("bookDate", $hmember->hjoindate), "id='bookDate' class='form-control'");
                            ?>
                        </div>
                            ...
                            <?php
                                ...
                                if(customCompute($hostelrooms)) {
                                    foreach ($hostelrooms as $key => $hr) {
                                        ...
                                        if($hr->hostelroomID==$hmember->hostelroomID){
                                            $cp= $hr;
                                        }
                                        
                                    }
                                }
                                echo form_dropdown("hostelroomID", $array, set_value("hostelroomID",$hmember->hostelroomID), "id='hostelroomID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="roomdiv">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="roomcapcity" name="roomcapcity" readonly value="<?=set_value('roomcapcity', $cp->roomcapcity)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                ...
                <div class="form-group <?=form_error('capcityoccopied') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="capcityoccopied" name="capcityoccopied" readonly value="<?=set_value('capcityoccopied', $cp->capcityoccopied)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php
                    $fee_breakup= unserialize($hmember->fee_details);
                    foreach($fee_breakup as $fb){


                    ?>

                        <div class="col-sm-4">
                            <input type="text" name="other_charges[]" id="hostelfee" value="<?php echo $fb['other_charges'] ?>" class="form-control" readonly>
                        </div>
                        <div class="col-sm-4">
                            <input type="text" name="other_charges_amount[]" id="hostelfee_amount" value="<?php echo $fb['other_charges_amount'] ?>" class="form-control totalsum" >
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="hostel_discount_amount" id="hostel_discount_amount" value="<?php echo $hmember->hostel_discount; ?>" class="form-control">
                        </div>
                        <span class="clearfix"></span>
                        <hr>
                        <span class="clearfix"></span>
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="total_amount" id="total_amount" value="<?php echo $hmember->hbalance; ?>" class="form-control">
                        </div>
                        <span class="clearfix"></span>
                        <hr>
                        <span class="clearfix"></span>
