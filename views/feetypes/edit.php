                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                             <?php
                                ...
                                echo form_dropdown("credit_id", $chofaccArray, set_value("credit_id", $feetypes->credit_id), "id='credit_id' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                             <?php
                                ...
                                echo form_dropdown("debit_id", $chofaccArray, set_value("debit_id", $feetypes->credit_id), "id='debit_id' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
