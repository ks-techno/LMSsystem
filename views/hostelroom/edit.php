...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_hostelroom')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("hostelID", $array, set_value("hostelID", $hostelroom->hostelID), "id='hostelID' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    <div class="form-group <?=form_error('hostelroom') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="hostelroom" name="hostelroom" value="<?=set_value('hostelroom', $hostelroom->hostelroom)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('monthlyfee') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="monthlyfee" name="monthlyfee" value="<?=set_value('monthlyfee', $hostelroom->monthlyfee)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('roomcapcity') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="roomcapcity" name="roomcapcity" value="<?=set_value('roomcapcity', $hostelroom->roomcapcity)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('security') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="security" name="security" value="<?=set_value('security', $hostelroom->security)?>" >
                        </div> 
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_hostelroom")?>" >
                        </div>
                    </div>
                </form>
            </div>
