                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th><?=$this->lang->line('paymenthistory_ref')?></th>
                                <th><?=$this->lang->line('paymenthistory_accounts')?></th>
                        ...
                        <tbody>
                            <?php if(customCompute($payments)) {$i = 1; foreach($payments as $payment) { if($payment->paymentamount != '') { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('paymenthistory_ref')?>">
                                        <?php echo $payment->refrence_no; ?>
                                    </td>
                                     <td data-title="<?=$this->lang->line('paymenthistory_ref')?>">
                                        <?php echo $payment->srroll; ?>
                                    </td>
