        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <?php
                                ...
                                if(customCompute($categories)) {
                                    foreach ($categories as $category) {
                                        if ($category->asset_categoryID==$asset->asset_categoryID) {
                    ...
                    <?php
                    if(form_error('asset_number'))
                        echo "<div class='form-group has-error' >";
                    else
                        echo "<div class='form-group' >";
                    ?>
                        <label for="asset_number" class="col-sm-2 control-label">
                            Code <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="asset_number" name="asset_number" value="<?=set_value('asset_number', $asset->asset_number)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="asset_condition" class="col-sm-2 control-label">
                            <?=$this->lang->line("asset_condition")?> 
                        </label>
                        <div class="col-sm-6">
                            <?php
