                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="publisher" class="col-sm-2 control-label">
                            Publisher <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="publisher" name="publisher" value="<?=set_value('publisher',$ebooks->publisher)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="year" name="year" value="<?=set_value('year',$ebooks->year)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
