                ...
                <div class="col-sm-12" style="margin-top:0px">
                   <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a class="transction-tab" data-toggle="tab" href="#fees_collection_details" aria-expanded="true"><?=$this->lang->line("transactionreport_expense_details")?></a></li>
