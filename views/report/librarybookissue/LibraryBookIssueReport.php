                                ...
                                <?php
                                    ...
                                    foreach($getLibrarybookissueReports as $getLibrarybookissueReport) { $i++; ?>
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('librarybookissuereport_name')?>">
                                               <!--   <?=$getLibrarybookissueReport->srname?>===<?=$getLibrarybookissueReport->usertypeID?>-><?=$getLibrarybookissueReport->check_out_to?> -->
                                                <?=getNameByUsertypeIDAndUserID($getLibrarybookissueReport->usertypeID,$getLibrarybookissueReport->check_out_to)?>
                                            (<?=$usertypes[$getLibrarybookissueReport->usertypeID]?>)</td>
                                            <td data-title="<?=$this->lang->line('librarybookissuereport_registerNO')?>">
                                                <?php 
                                                if ($getLibrarybookissueReport->usertypeID==3) {
                                                    echo $getLibrarybookissueReport->srregisterNO;
                                                }
                                                ?>
                                            </td>
