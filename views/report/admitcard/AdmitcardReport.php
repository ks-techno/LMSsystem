...
<div class="box">
    ...
    <div id="printablediv">
        ...
        <div class="box-body" style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-sm-12">
                    <div class=" <?php if (!$is_download) { echo 'mainadmincardrepor';}?>">
                ...
                if(!file_exists($filepath)) {
                    generate_qrcode($text,$filename);
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-3">
                                <h4><?=$examTitle?> <?=$this->lang->line('admitcardreport_exam_admit_card')?> - ( <?=$examYear?> )</h4>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <?php 
                        $admit_file     =   "uploads/exam/$examID/".$student->srregisterNO.'.pdf';

                                     
                                    if (is_file($admit_file)) {
                                          ?>
                                          <a href="<?php echo base_url('/').$admit_file;?>" target="_blank" class="btn btn-success">Download</a>
                                          <?php
                                    }else{
                                        ?>
                        ...
                        <hr>
                            ...
                            <div class="admincardreport" style="height:480px">
                                ...
                                <div class="admitcardfooter">
                                    ...
                                    <span class="headmaster_signature"><img style="width:90px;height: 80px; padding-top: 12px" src="<?=base_url('uploads/idQRcode/'.$filename.'.png')?>" alt=""></span>
                                </div>
