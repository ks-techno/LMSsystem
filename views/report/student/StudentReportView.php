    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group col-sm-4" id="reportDiv">
                    ...
                    <?php
                         $array = array(
                             ...
                             "active" => $this->lang->line("studentreport_stu_status"),
                ...
                <div class="form-group col-sm-4" id="activeDiv">
                    <label><?=$this->lang->line("studentreport_stu_status")?><span class="text-red"> * </span></label>
                    <?php
                    $activeArray = array(
                        'abc' => $this->lang->line("studentreport_please_select"), 
                        'select' => $this->lang->line("studentreport_inactive"),
                        // '0' => $this->lang->line("studentreport_inactive"),
                        '1' => $this->lang->line("studentreport_active"),
                    );
                    echo form_dropdown("active", $activeArray, set_value("active"), "id='active' class='form-control select2'");
                    ?>
                </div>
...
<script type="text/javascript">
    ...
    function validation_checker(field, error) {
        ...
        if (field['reportfor'] == 'active') {
            if (field['active'] == 0) {
                $('#activeDiv').addClass('has-error');
                error++;
            } else {
                $('#activeDiv').removeClass('has-error');
            }
        }
