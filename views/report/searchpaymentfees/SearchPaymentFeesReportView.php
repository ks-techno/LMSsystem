        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group col-sm-4" id="gspaymentIDDiv">
                   ...
                   <input class="form-control" type="text" name="gspaymentID" id="gspaymentID" value="INV-S-">
                </div>
            ...
            <div class="clearfix"></div>
                <div class="col-sm-12">
                            <p><b>Note:</b> INV-S-Challan Number: View format.</p>
                            <p><b>Note:</b> INV-G-Challan Number: Print format.</p>
                </div>              
            </div>
