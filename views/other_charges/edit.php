        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("other_charges/index")?>"><?=$this->lang->line('menu_invoice')?></a></li>
...
<script type="text/javascript">
    ...
    $('#classesID').change(function(event) {
        ...
        if(classesID === '0') {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('other_charges/getstudent')?>",
...
<script type="text/javascript">
    ...
    function ajaxCall(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('other_charges/saveinvoicefforedit')?>",
            data: passData,
            async: true,
            dataType: "html",
            success: function(data) {
