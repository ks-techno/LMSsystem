...
<!-- New Code -->
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="accession_number" name="accession_number" value="<?=set_value('accession_number')?>" >
                        </div>
 ...
 <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="ddc_number" name="ddc_number" value="<?=set_value('ddc_number')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        if(form_error('book_category')) 
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="book_category_" class="col-sm-2 control-label">
                            <?=$this->lang->line("book_category")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_category" name="book_category" value="<?=set_value('book_category')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('book_category'); ?>
                        </span>
                    </div>
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_publisher" name="book_publisher" value="<?=set_value('book_publisher')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_year" name="book_year" value="<?=set_value('book_year')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_pages" name="book_pages" value="<?=set_value('book_pages')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
             ...
             <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_binding" name="book_binding" value="<?=set_value('book_binding')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_source" name="book_source" value="<?=set_value('book_source')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
         ...
         <?php 
            ...
            <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_volume" name="book_volume" value="<?=set_value('book_volume')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
            ...
            <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_edtion" name="book_edtion" value="<?=set_value('book_edtion')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
            ...
            <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="book_remarks" name="book_remarks" value="<?=set_value('book_remarks')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
