            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="category_abbr" name="category_abbr" value="<?=set_value('category_abbr')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("cat_type", $array, set_value("cat_type"), "id='cat_type' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
