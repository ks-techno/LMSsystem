                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="name" class="col-sm-2 control-label">
                          Company  <?=$this->lang->line("vendor_name")?>  <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="tax_rate" name="tax_rate" value="<?=set_value('tax_rate')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="vendor_strn" name="vendor_strn" value="<?=set_value('vendor_strn')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="vendor_ntn" name="vendor_ntn" value="<?=set_value('vendor_ntn')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="vendor_bank" name="vendor_bank" value="<?=set_value('vendor_bank')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="vendor_branch_code" name="vendor_branch_code" value="<?=set_value('vendor_branch_code')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="vendor_account_title" name="vendor_account_title" value="<?=set_value('vendor_account_title')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="vendor_account_number" name="vendor_account_number" value="<?=set_value('vendor_account_number')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
