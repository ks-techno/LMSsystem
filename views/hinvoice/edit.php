            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                       ...
                       <?php 
                        if(form_error('hostel_discount')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="hostel_discount" class="col-sm-2 control-label">
                            Discount <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                 
                                echo form_input("hostel_discount", set_value("hostel_discount",$hmember->hostel_discount), "id='hostel_discount' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('hostel_discount'); ?>
                        </span>
                    </div>
