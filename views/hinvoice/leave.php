        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <?php 
                        if(form_error('leftDate')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="leftDate" class="col-sm-2 control-label">
                            Left Date <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                 
                                echo form_input("leftDate", set_value("leftDate"), "id='leftDate' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('leftDate'); ?>
                        </span>
                    </div>

                    <?php 
                        if(form_error('leftReason')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="leftReason" class="col-sm-2 control-label">
                            Left Reason <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                 
                                echo form_input("leftReason", set_value("leftReason"), "id='leftReason' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('leftReason'); ?>
                        </span>
                    </div>
