            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                      ...
                      <?php 
                        if(form_error('exam_year')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="exam_year" class="col-sm-2 control-label">
                            Exam Year <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="exam_year" name="exam_year" value="<?=set_value('exam_year', $exam->exam_year)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('exam_year'); ?>
                        </span>
                    </div>
