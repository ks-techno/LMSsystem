                            ...
                            <?php if(customCompute($maininvoices)) {$i = 1; foreach($maininvoices as $maininvoice) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                        ...
                                        <?php echo btn_edit('libraryfine/edit/'.$maininvoice->maininvoiceID, $this->lang->line('edit')) ?>
                                        <?php echo btn_delete('libraryfine/delete/'.$maininvoice->maininvoiceID, $this->lang->line('delete'))?>
...
<script type="text/javascript">
    ...
    $('#studentID').change(function() {
        ...
        if(studentID == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('libraryfine/student_list')?>",
                data: "id=" + studentID,
                dataType: "html",
