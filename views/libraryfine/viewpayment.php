    ...
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php
                 echo btn_add_pdf('libraryfine/print_previewviewpayment/'.$globalpayment->globalpaymentID.'/'.$maininvoice->maininvoiceID, $this->lang->line('pdf_preview')) 
                ?>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $("#send_pdf").click(function(){
            ...
            if(error == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?=base_url('libraryfine/viewpayment_send_mail')?>",
                    data: field,
                    dataType: "html",
