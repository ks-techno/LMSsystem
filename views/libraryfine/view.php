        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                $maininvoice_ID = $this->uri->segment($secondLastKey);
                 echo btn_add_pdf('libraryfine/print_preview/'.$maininvoice_ID, $this->lang->line('pdf_preview')) 
                ?>
                    ...
                    <?php
                        if(permissionChecker('invoice_edit')) {
                            if($maininvoice->maininvoicestatus != 1 && $maininvoice->maininvoicestatus != 2) {
                                ...
                                echo btn_sm_edit('libraryfine/edit/'.$maininvoice_ID, $this->lang->line('edit'));
                            }
                        }
                    ?>
                <?php } ?>
                <?php
                    if($maininvoice->maininvoicestatus != 2) {
                        echo btn_payment('libraryfine/payment/'.$maininvoice_ID, $this->lang->line('payment')); 
                    }
                ?>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("libraryfine/index")?>"><?=$this->lang->line('menu_invoice')?></a></li>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $("#send_pdf").click(function(){
            ...
            if(error == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?=base_url('libraryfine/send_mail')?>",
                    data: field,
                    dataType: "html",
