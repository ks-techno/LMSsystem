           ...
           <table>
                            <tbody>
                              <tr>
                                ...
                                <td align="left">P.O-<?php echo $productpurchase->productpurchaseID;?></td>
                              </tr>
                              <tr>
                                <th  align="left">Purchase Order Date</th>
                                <td   align="left">
                                  <div>
                                    <span><?php echo date('D, d-m-Y',strtotime($productpurchase->productpurchasedate));?></span>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
        ...
        <td width="34%">
            <table >
              <tbody>
                  ...
                  <?php if($productpurchase->aprove_status_first === '1'){?>
            ...
            <table >
              <tbody>
                  <tr>
                   ...
                   <?php if($productpurchase->aprove_status_second === '1'){?>
