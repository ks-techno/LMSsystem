...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_asset_requisition')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                $array[0] = $this->lang->line('asset_requisition_select_asset');
                        ...
                        <div class="col-sm-6">
                            <?php
                                echo form_dropdown("status", array(
                                    0 => $this->lang->line('asset_requisition_select_status'),
                                    1 => $this->lang->line('asset_requisition_checked_out'),
                                    2 => $this->lang->line('asset_requisition_in_storage')
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                $userArray[''] = $this->lang->line('asset_requisition_select_usertype');
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                $userArray = array(
                                    '' => $this->lang->line('asset_requisition_select_user')
                                );  
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_asset_requisition")?>" >
                        </div>
                    </div>
                </form>
            </div>
